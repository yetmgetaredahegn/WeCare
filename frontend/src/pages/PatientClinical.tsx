...
import { useMedicalRecords, usePrescriptions } from "@/features/clinical/queries";
...
const PatientClinical = () => {
    ...
    useEffect(() => {
        if (recordsError) {
            showToast(getErrorMessage(recordsError, "Unable to load records."), "error");
        }
    ...
    return (
        <div className="space-y-10">
            ...
            <section className="bg-white rounded-xl shadow-sm p-6 space-y-4 dark:bg-black">
                <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 dark:bg-black">My Medical Records</h2>
                        ...
                        >
                            <div className="flex flex-wrap justify-between gap-2">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400">{record.diagnosis?.code}</p>
                                </div>
            ...
            <section className="bg-white dark:bg-black rounded-xl shadow-sm p-6 space-y-4">
